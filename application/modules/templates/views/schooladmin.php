...
<head>
    ...
    <link href="<?php echo base_url(); ?>adminfiles/assets/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>school_facilities/manage">
                            <i class="material-icons">assignment</i>
                            <span>Manage Facility</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>requirements/manage">

...
<body class="login-page">
    ...
    <script src="<?php echo base_url(); ?>adminfiles/assets/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="<?php echo base_url(); ?>adminfiles/assets/js/admin.js"></script>
    <script src="<?php echo base_url(); ?>adminfiles/assets/js/pages/examples/sign-in.js"></script>
</body>
